...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'og:description', property: 'og:description', name: 'og:description', content: siteDesc },
      { hid: 'og:image', property: 'og:image', name: 'og:image', content: imageShare },
      { hid: 'image', property: 'image', name: 'image', content: imageShare },
      ...
      { hid: 'image', name: 'image', content: imageShare },
