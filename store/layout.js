export const state = () => ({
  mobile: isMobile(),
  tablet: !isMobile() && isMobileOrTablet(),
  desktop: !isMobile() && !isMobileOrTablet(),
  sound: true,
  menu: false,
  errorPage: false
})
...
export const mutations = {
  setDevice (state) {
    ...
    state.tablet = !isMobile() && isMobileOrTablet()
    state.desktop = !isMobile() && !isMobileOrTablet()
  },
  setSound (state, status) {
    state.sound = status
  },
  setMenu (state, status) {
    state.menu = status
  },
  setErrorPage (state, status) {
